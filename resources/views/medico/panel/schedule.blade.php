    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-6 text-right">
          <a href="{{route('medico_diary',$medico->id)}}" type="button" name="button" class="btn btn-secondary">Atras</a>
        </div>
      </div>
      <div class="my-4 card">
              ...
              <div class="col-5">
                  ...
                  <div class="form-inline">
                    ...
                    <div class="form-group mt-3" >
                        ...
                        <a href="{{route('medico_diary',$medico->id)}}" class="btn btn-primary">Cancelar</a>
                    </div>
