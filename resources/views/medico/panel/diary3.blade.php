    ...
    <div class="col-lg-9 col-12">
      ...
      <div class="" id="example">
        ...
        <div class="row mt-2">
          <div class="col-12">
            <div class="row">
              <div class="radio col text-center">
               <!--  <input id="radio-1" name="radio" type="radio" checked> -->
                <input class="radio-diary" type="radio" id="radio-1" value="Disponible" name="opcion" onclick="filtroDisponible()"/>
                <label for="radio-1" class="radio-label text-center">Disponible</label>
              </div>
              <div class="radio col text-center"> 
                <input class="radio-diary" type="radio" id="radio-2" value="A" name="opcion" onclick="filtroCitaPorInternet()"/>
                <label for="radio-2" class="radio-label text-center">Cita por internet</label>
              </div>
              <div class="radio col text-center"> 
                <input class="radio-diary" type="radio" id="radio-3" value="A" name="opcion" onclick="CerradaYCobrada()"/>
                <label for="radio-3" class="radio-label text-center">Cerrada y cobrada</label>
              </div>
              <div class="radio col text-center"> 
               <input class="radio-diary" type="radio" id="radio-4" value="A" name="opcion" onclick="PendientePorCobrar()"/>
               <label for="radio-4" class="radio-label text-center">Por cobrar</label>
             </div>
             <div class="radio col text-center"> 
              <input class="radio-diary" type="radio" id=radio-5 value="A" name="opcion" onclick="FiltroPacienteCancelo()"/>
              <label for="radio-5" class="radio-label text-center">Paciente cancelo</label>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-12 text-center">
            <div class="row my-3">
              <div class="col-lg-11 col-10">
               <h4 class="font-title-blue text-center">Horario de trabajo</h4>
             </div>
             <div class="col-lg-1 col-2">
               <a href="{{route('medico_schedule',$medico->id)}} "data-toggle="tooltip" data-placement="top" title="Editar" class="btn"><i class="fas fa-pencil-alt"></i></a>
             </div>
           </div>
         </div>
       </div>
...
<!--         <div class="row">
          <fieldset class="rate">
            <input id="rate1-star5" class="rate-star" type="radio" name="rate1" value="5" />
            <label for="rate1-star5" class="rate-label" title="Excellent">5</label>

            <input id="rate1-star4" class="rate-star" type="radio" name="rate1" value="4" />
            <label for="rate1-star4" class="rate-label" title="Good">4</label>

            <input id="rate1-star3" class="rate-star" type="radio" name="rate1" value="3" />
            <label for="rate1-star3" class="rate-label" title="Satisfactory">3</label>

            <input id="rate1-star2" class="rate-star" type="radio" name="rate1" value="2" />
            <label for="rate1-star2" class="rate-label" title="Bad">2</label>

            <input id="rate1-star1" class="rate-star" type="radio" name="rate1" value="1" />
            <label for="rate1-star1" class="rate-label" title="Very bad">1</label>
          </fieldset>
        </div> -->
    <!-- END RATING -->
          ...
          <div class="border-panel-blue my-1">
            <div class="form-group text-center">
              <div class="form-group">
                <label for="" class="font-title-blue mt-2">Agendar Evento Personal</label>
              </div>

              {!!Form::open(['route'=>'medico_diary.store','method'=>'POST'])!!}
              <input class="form-control my-1" type="text" placeholder="Titulo" id="title2">
              ...
              <input class="form-control my-1" type="text" placeholder="Descripción (Opcional)" id="description2">
              <input class="form-control my-1" type="text" placeholder="Precio (Opcional)" id="price2">
              <div class="row">
                <div class="col-4 font-title">
                  <label for="" class="font-title-grey col-form-label">Inicio:</label>
                </div>
                <div class="col-8">
             ...
             <div class="row mt-1">
              <div class="col-4 font-title">
                <label for="" class="font-title-grey col-form-label"">Hora:</label>
              </div>
            ...
            <div class="row">
              <div class="col-4">
                <label for="" class="font-title-grey col-form-label">Fecha:</label>
              </div>
              <div class="col-8">
