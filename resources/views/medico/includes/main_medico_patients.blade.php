  ...
  <div class="col-lg-6 m-auto text-center">
    <div class="row">
      <div class="col-lg col-12 d-flex justify-content-center">
        <a href="{{route('medico_appointments_patient',['medico_id'=>$medico->id,'patient_id'=>$patient['id']])}}" class="btn btn-lg btn-menu-medico btn-menu-medico-azul" data-toggle="tooltip" data-placement="top" title="Citas Paciente"><i class="far fa-calendar-alt"></i></a>
        @if($medico->plan == 'plan_profesional' or $medico->plan == 'plan_platino')
        <a href="{{route('notes_patient',['m_id'=>$medico->id,'p_id'=>$patient->id])}}" class="btn btn-lg btn-menu-medico btn-menu-medico-verde" data-toggle="tooltip" data-placement="top" title="Notas de Paceinte"><i class="fas fa-notes-medical"></i></a>
        @endif
