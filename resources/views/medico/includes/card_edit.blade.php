<div class="card p-2" id="card_edit" style="display:none">
  ...
  <div class="row">
    <div class="col-lg-3 col-12">
      <div class="form-group">
        ...
        {!!Form::text('price',null,['class'=>'form-control','id'=>'price9'])!!}
      </div>
    </div>
    <div class="col-lg-3 col-12">
      <div class="form-group">
  ...
  <div class="row">
    ...
    <div class="col-3">
      ...
      {{Form::select('state',['Pendiente'=>'Pendiente','Pagada'=>'Pagada','Cerrada y Cobrada'=>'Cerrada y Cobrada'],null,['class'=>'form-control','id'=>'state9'])}}
    </div>
    <div class="col-6 row">
      <div class="col-12 text-center">
        ...
        <div class="col-6">
          <div class="form-inline">
            ...
            {{Form::text('confirmed_medico',null,['class'=>'form-control','style'=>'width:70px','disabled','id'=>'confirmed_medico9'])}}
          </div>
        </div>
    </div>
  </div>
  <div class="row mt-3">
    <div class="col-3">
     ...
     <div class="col-3">
       ...
       {{-- <button onclick="update_event()" type="button" name="button" class="btn btn-success btn-block" id="guardar">Guardar/confirmar</button> --}}
       {{-- <input name="mysubmit" type="submit" value="Guardar/confirmar" class="btn btn-success btn-block" id="guardar"/> --}}
     </div>
   <div class="col-3">
     <button onclick="confirmar2()" type="button" name="button" class="btn btn-info btn-block" id="confirmar">Confirmar Cita</button>

   </div>
   <div class="col-3">
     <button onclick="cerrar()" type="button" name="button" class="btn btn-secondary btn-block" id="confirmar">Cerrar</button>
   </div>
</div>
{!!Form::close()!!}
</div>
