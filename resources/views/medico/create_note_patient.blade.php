    ...
    <div class="row">
      <div class="col-lg-9 col-12">
        ...
        <div class="register">
          <div class="row">
            <div class="col-12">
              <h2 class="text-center font-title">Crear Nueva Nota para Paciente: <span>{{$patient->name }} {{$patient->lastName }}</span></h2>
              <hr>
            </div>
          </div>
          <div class="row justify-content-center mb-2">
            <div class="col-8 -auto">
              <div class="row">
                ...
                <div class="col-lg-2 mt-3 col-12">
                  <a href="{{route('notes_patient',['m_id'=>$medico->id,'p_id'=>$patient->id])}}" class="btn btn-secondary">Notas Médicas</a>
