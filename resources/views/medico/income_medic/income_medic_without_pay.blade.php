...
<section class="box-register">
	...
	<div class="container">
      ...
      <h3>Ingresos</h3>
        ...
        <a href="{{route('income_medic',request()->id)}}" class="btn btn-primary">Citas Cobradas</a>
        <a href="{{route('income_medic_without_pay',request()->id)}}" class="btn btn-warning disabled">Citas por Cobrar</a>
        <div class="">
