          ...
          <div class="col-12">
            ...
            <div class="row my-5">
              <div class="col-6 col-lg">
                <div class="box-img">
                  <a href=""><img src="img/botones-medicossi-01.jpg" alt="Centros medicos y hospitales" width="100%" class="img-responsive"></a>
                </div>
              </div>
              <div class="col-6 col-lg">
                <div class="box-img">
                  <a href=""><img src="img/botones-medicossi-05.jpg" alt="Medicos y especialistas" width="100%" class="img-responsive"></a>
                </div>
              </div>
              <div class="col-6 col-lg">
                <div class="box-img">
                  <a href=""><img src="img/botones-medicossi-03.jpg" alt="Dentistas" width="100%" class="img-responsive"></a>
                </div>
              </div>
              <div class="col-6 col-lg">
                <div class="box-img">
                  <a href=""><img src="img/botones-medicossi-11.jpg" alt="Terapeuta y nutrición" width="100%" class="img-responsive"></a>
                </div>
              </div>
              <div class="col-6 col-lg">
                <div class="box-img">
                  <a href=""><img src="img/botones-medicossi-10.jpg" alt="Medicina alternativa" width="100%" class="img-responsive"></a>
                </div>
              </div>
            </div>
          </div>
