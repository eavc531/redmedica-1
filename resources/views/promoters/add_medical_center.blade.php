    ...
    <div class="register">
      <div class="row">
        <div class="col-12 mb-3">
          <h2 class="text-center font-title">Registro de centro médico como invitado</h2>
        </div>
      </div>


        {!!Form::open(['route'=>'store_medical_center','method'=>'POST'])!!}
          {{Form::hidden('promoter_id',Auth::user()->promoter->id,['class'=>'form-control'])}}
          <div class="row">
