		...
		<div class="register">
			<div class="row">
				<div class="col-12 mb-3">
					<h2 class="text-center font-title">Registro de Profesional Médico como Invitado</h2>
				</div>
			</div>

			{!!Form::open(['route'=>'store_medic','method'=>'POST'])!!}
      {{Form::hidden('promoter_id',Auth::user()->promoter->id)}}
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-12">
					<div class="form-group">
						{!!Form::select('specialty',$specialties,'Mèxico',['class'=>'form-control','placeholder'=>'Especialidad'])!!}
					</div>
				</div>
			</div>
			<div class="row">
