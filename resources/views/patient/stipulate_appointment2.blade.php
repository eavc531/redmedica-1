...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-9 col-sm-8 col-12">
      ...
      <div class="" id="example">
        ...
        <div id="alert_success_1" class="alert alert-success alert-dismissible fade show text-left" role="alert" style="display:none">
         ...
         <a href="{{route('patient_appointments_pending',Auth::user()->patient->id)}}" class="btn btn-outline-primary">ver mis Consultas Pendientes</a>
   ...
   <div class="col-lg-3 col-sm-4 col-12">
    <div id="dashboard" class="margin-date">
